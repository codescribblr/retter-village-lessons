# this is an example of a monster game I built when I was learning python. It's not exacly the same, but it uses many of the same concepts. You can read through this to get an idea of how to build the different pieces we'll be building. 
...
def get_locations(grid):
    ...
    while True:
        ...
        if not (locations_dict['monster'] == locations_dict['door'] and locations_dict['monster'] == locations_dict[
            'start'] and locations_dict['door'] == locations_dict['start']):
            break
...
while True:
    ...
    if player_choice == 'HELP':
        ...
        if new_room in players_moves:
            ...
            while True:
                if difficulty == 'hard':
                    starting_locations['monster'] = move_player(starting_locations['monster'],
